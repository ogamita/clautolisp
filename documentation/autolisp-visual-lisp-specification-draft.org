...
** Source Notes
- Current vendor corpus sampled in `documentation/autolisp-reference-notes.org`
...
* Open Work
The following areas remain incomplete and are governed by `documentation/specification-resolution-plan.org`:
