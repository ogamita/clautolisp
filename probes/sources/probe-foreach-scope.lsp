...
(defun cad-probe-foreach--return-value ()
  ;; The documented return: the last body value, nil for an empty body.
...
(defun cad-probe-run-foreach-scope-probes ()
  ...
  (cad-probe--foreach
   "return value: last body value, empty body, empty list"
   "(list (foreach e '(1 2 3) (* e 10)) (foreach e '(1 2 3)) (foreach e nil 99))"
