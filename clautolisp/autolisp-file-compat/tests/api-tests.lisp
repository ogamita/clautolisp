...
(test declarative-multi-step-stream-and-printer-scenarios
  (dolist (path '("autolisp-file-compat/scenarios/streams/open-write-read-line-basic.sexp"
                  "autolisp-file-compat/scenarios/streams/open-current-directory-relative.sexp"
                  "autolisp-file-compat/scenarios/streams/open-current-directory-append.sexp"
                  "autolisp-file-compat/scenarios/streams/open-current-directory-subdir-backslash.sexp"
                  ...
                  "autolisp-file-compat/scenarios/printers/file-prin1-current-directory-roundtrip.sexp"
                  "autolisp-file-compat/scenarios/printers/file-princ-current-directory-roundtrip.sexp"
                  "autolisp-file-compat/scenarios/printers/file-princ-read-roundtrip.sexp"
...
(test declarative-builtin-scenario-files
  (dolist (path '("autolisp-file-compat/scenarios/paths/findfile-basic.sexp"
                  ...
                  "autolisp-file-compat/scenarios/mutations/file-delete-current-directory-relative.sexp"
                  ...
                  "autolisp-file-compat/scenarios/mutations/file-size-current-directory-backslash.sexp"
